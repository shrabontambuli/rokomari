                    ...
                    <div className="drawer-side text-white">
                        ...
                        <ul className="menu pt-10 w-64 h-full box2 text-base-content items-center">
                            <div>
                                ...
                                <Link to='/dashboard'>
                                    <h1 className="mt-6 flex items-center text-white text-xl font-bold"><svg className="me-2" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 37 37" fill="none">
